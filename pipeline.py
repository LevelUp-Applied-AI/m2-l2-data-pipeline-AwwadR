...
def create_visualizations(df, output_dir=OUTPUT_DIR):
    ...
    ax.bar(revenue_by_category.index, revenue_by_category.values, color = "#F6438B")
    ...
    fig, ax = plt.subplots(figsize=(10, 6))
    ax.plot(daily_revenue.index, daily_revenue.values, color = "#24A5DC")
    ...
    fig, ax = plt.subplots(figsize=(10, 6))
    ax.barh(avg_order_by_payment.index, avg_order_by_payment.values, color = "#A41EB9")
